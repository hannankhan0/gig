...
const st = {
  root: { minHeight: '100vh', background: 'radial-gradient(circle at top left, #2b1a05 0, #090909 34%, #050505 100%)', color: '#fff', display: 'grid', placeItems: 'center', padding: 24, fontFamily: "'DM Sans', system-ui, sans-serif" },
  shell: { width: 'min(1040px, 100%)', background: 'rgba(17,17,17,0.92)', border: '1px solid #2b2b2b', borderRadius: 22, boxShadow: '0 24px 90px rgba(0,0,0,0.55)', display: 'grid', gridTemplateColumns: '1fr 1.05fr', overflow: 'hidden' },
  summary: { padding: 34, background: 'linear-gradient(145deg, #121212, #0b0b0b)' },
  formPane: { padding: 34, background: '#101010' },
  brand: { color: '#f59e0b', fontWeight: 900, marginBottom: 28 },
  heading: { margin: 0, fontSize: '2rem' },
  muted: { color: '#8b8b8b', lineHeight: 1.55 },
  order: { background: '#0b0b0b', border: '1px solid #252525', borderRadius: 16, padding: 16, marginTop: 22 },
  row: { display: 'flex', justifyContent: 'space-between', gap: 20, padding: '10px 0', borderBottom: '1px solid #202020', color: '#aaa' },
  ...
  method: { background: '#171717', color: '#aaa', border: '1px solid #2b2b2b', borderRadius: 12, padding: '13px 10px', cursor: 'pointer', fontWeight: 900 },
  methodActive: { color: '#000', background: '#f59e0b', borderColor: '#f59e0b' },
  ...
  input: { background: '#0b0b0b', border: '1px solid #2d2d2d', color: '#fff', borderRadius: 11, padding: '13px 13px', outline: 'none', fontSize: '0.95rem' },
  pay: { width: '100%', background: '#f59e0b', color: '#000', border: 0, borderRadius: 12, padding: '14px 18px', marginTop: 20, cursor: 'pointer', fontWeight: 950, fontSize: '1rem' },
  ...
  successCard: { width: 'min(560px, 100%)', background: '#111', border: '1px solid #2b2b2b', borderRadius: 22, padding: 34, textAlign: 'center', boxShadow: '0 24px 90px rgba(0,0,0,0.55)' },
  successMark: { width: 62, height: 62, borderRadius: '50%', background: '#052e16', color: '#4ade80', display: 'grid', placeItems: 'center', margin: '0 auto 14px', fontSize: '2rem', fontWeight: 900 },
  ...
  primary: { background: '#f59e0b', color: '#000', border: 0, borderRadius: 10, padding: '11px 16px', cursor: 'pointer', fontWeight: 900 },
  secondary: { background: '#1a1a1a', color: '#ddd', border: '1px solid #333', borderRadius: 10, padding: '11px 16px', cursor: 'pointer', fontWeight: 800 },
  footer: { color: '#666', fontSize: '0.76rem', marginTop: 16 },
